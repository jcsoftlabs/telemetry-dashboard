...
import { getPerformanceStats } from '@/lib/api/telemetry';
...
export default function PerformancePage() {
    ...
    const { data, loading, error } = usePolling(
        async () => {
            ...
            return getPerformanceStats(session.accessToken);
        },
        5000,
        !!session?.accessToken
    );
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Performances API</h1>
